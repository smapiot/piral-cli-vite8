...
# piral-cli-vite8 &middot; [![build](https://github.com/smapiot/piral-cli-vite8/actions/workflows/ci.yml/badge.svg)](https://github.com/smapiot/piral-cli-vite8/actions/workflows/ci.yml) ![GitHub License](https://img.shields.io/badge/license-MIT-blue.svg)

The `piral-cli` plugin for using `vite` (**version 8**) as bundler.
