...
# [Piral CLI Vite 8](https://piral.io) &middot; [![GitHub License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/smapiot/piral-cli-vite8/blob/main/LICENSE) [![npm version](https://img.shields.io/npm/v/piral-cli-vite8.svg?style=flat)](https://www.npmjs.com/package/piral-cli-vite8) [![tested with jest](https://img.shields.io/badge/tested_with-jest-99424f.svg)](https://jestjs.io) [![Community Chat](https://img.shields.io/discord/1222632475449229352)](https://discord.gg/kKJ2FZmK8t)

This plugin enables using [Vite 8](https://vitejs.dev/) as the bundler for Piral instances and pilets.
...
```sh
npm i piral-cli-vite8 --save-dev
```

**Note**: If you don't install any bundler for use in `piral-cli` then `piral-cli-vite8` will be automatically installed for you.

## Using

There is nothing to do. Standard commands such as `piral build` or `pilet debug` will now work with Vite 8 as the bundler.
